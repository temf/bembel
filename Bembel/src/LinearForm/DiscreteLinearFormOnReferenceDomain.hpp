...
// information.
#ifndef BEMBEL_LINEARFORM_DISCRETELINEARFORMONREFERENCEDOMAIN_H_
#define BEMBEL_LINEARFORM_DISCRETELINEARFORMONREFERENCEDOMAIN_H_
...
class DiscreteLinearFormOnReferenceDomain {
 public:
  //////////////////////////////////////////////////////////////////////////////
  //    constructors
  //////////////////////////////////////////////////////////////////////////////
  DiscreteLinearFormOnReferenceDomain() {}
  DiscreteLinearFormOnReferenceDomain(const AnsatzSpace<LinOp> &ansatz_space) {
    init_DiscreteLinearFormOnReferenceDomain(ansatz_space);
  }
  //////////////////////////////////////////////////////////////////////////////
  //    init_DiscreteLinearFormOnReferenceDomain
  //////////////////////////////////////////////////////////////////////////////
  void init_DiscreteLinearFormOnReferenceDomain(
  ...
  void compute() {
    ...
    for (auto element = element_tree.cpbegin(); element != element_tree.cpend();
      ...
      for (auto i = 0; i < Q.w_.size(); ++i) {
        ...
        lf_.evaluateIntegrand_impl(super_space, qp, &intval, element->patch_);
      }
