...
int main() {
  ...
  DiscreteOperator<H2Matrix<std::complex<double>>, HelmholtzSingleLayerOperator>
  ...
  // evaluate potential
  DiscretePotential<HelmholtzSingleLayerPotential<HelmholtzSingleLayerOperator>,
                    HelmholtzSingleLayerOperator>
  ...
  double error = (pot - pot_ref).cwiseAbs().maxCoeff();
